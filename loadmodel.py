...
class CarEnv:
    ...
    def reset(self):
        try:
            ...
            # SENSORSSSSSSSSSSSSSSSSSSSSSSSSS ################################
            # self.sensors = [
    ...
    def process_img(self, image):
        ...
        # # Setting the Middle Image
        # pred_seg_image = predict_segmentation(
        #     DEEP_LAP_MODEL, i3[:, :, ::-1])[:, :, ::-1]
        # self.front_camera_rgb = pred_seg_image
        # self.front_camera_all_windows[:, :self.im_width] = pred_seg_image/255.
...
## Load Model ##
################
MODEL_PATH = 'models/Xception_____-205.00max____-344.50avg_-570.00min_100000episodes__1642751872.model' ## model path
import keras
...
model = CustomModel([480,640, 3])

model = load_model(
    "models/Xception__-220.00max_-236.60avg_-283.00min__1642587019.model", custom_objects={"CustomModel": CustomModel}
)
